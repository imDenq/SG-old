    ...
    public static class Processor {
        ...
        public boolean run() {
            ...
            if (this.phase == 0) {
                ...
                this.processingX = 0;
                this.phase = 1;
                Bukkit.getConsoleSender().sendMessage(Color.translate("&7Road load &7[&c1/3&7]"));
            }
            if (this.phase == 1) {
                ...
                this.phase = 2;
                Bukkit.getConsoleSender().sendMessage(Color.translate("&7Road load &7[&c2/3&7]"));
            }
            if (this.phase == 2) {
                ...
                Bukkit.getConsoleSender().sendMessage(Color.translate("&7Road load &7[&a3/3&7]"));
            }
            if (this.phase == 3) {
        ...
        public Material getRoadMaterial() {
            List<String> materials = FoxySG.getInstance().getConfiguration("config").getStringList("ROADS.ROAD-MATERIALS");
