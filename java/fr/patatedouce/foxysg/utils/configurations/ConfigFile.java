package fr.patatedouce.foxysg.utils.configurations;
...
public class ConfigFile {
    ...
    public ConfigFile(String name) {
        this.name = name;
        this.file = new File(FoxySG.getInstance().getDataFolder(), name + ".yml");
        if (!this.file.exists()) {
            FoxySG.getInstance().saveResource(name + ".yml", false);
        }
