...
public class ItemBuilder {
	...
	public ItemBuilder setName(String name) {
		...
		im.setDisplayName(fr.patatedouce.foxysg.utils.chat.Color.translate(name));
		is.setItemMeta(im);
		return this;
	}
	...
	public ItemBuilder setNameWithArrows(String name) {
		String color = "&c";
		ItemMeta im = is.getItemMeta();
		im.setDisplayName(fr.patatedouce.foxysg.utils.chat.Color.translate(color + Symbols.ARROW_RIGHT + " " + name + " " + color + Symbols.ARROW_LEFT));
		is.setItemMeta(im);
		return this;
	}
	...
	public ItemBuilder addLoreLine(String line) {
		...
		lore.add(fr.patatedouce.foxysg.utils.chat.Color.translate(line));
		im.setLore(lore);
		is.setItemMeta(im);
		return this;
	}
